...
class mainViewController: SideMenuController {
    ...
    override func viewDidLoad() {
        ...
        let tabViewController3 = self.storyboard?.instantiateViewController(withIdentifier: "usersChatView")
        let tabViewController4 = self.storyboard?.instantiateViewController(withIdentifier: "settingView")
        ...
        tabViewController3?.tabBarItem = UITabBarItem(
            title: "",
            image:UIImage(named: "message_icon") ,
            tag:3)
